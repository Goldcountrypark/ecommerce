...
// değişkene atıyoruz (products)

let products = [];
// değişkene atıyoruz (cart)
...
function productsFunc(products) {
  ...
  // değişkene atıyoruz (productsContainer) index.html deki ul ye verilen id="product-list"
  let results = "";
  // let değiştirilebilir const sabittir değiştirilemez
  // foreach ile dizinden çıkarıp listeliyoruz data.json dan çekiyoruz
